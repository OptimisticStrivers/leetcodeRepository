package edu.cmu.optimisticStrivers.sort.compareMSandQS;
...
//快排最坏是o(n2) -> o(nlogn)
//归并是o(nlogn)
//但是我们一般认为快排快，因为归并需要额外一个数组，且修改不是inplace，写操作变多了: from->to to->from
//extra modification

//修改快排的最坏情况->random pivot,或者递归的时候，快排所有<pivot的左 和 >pivot的右
